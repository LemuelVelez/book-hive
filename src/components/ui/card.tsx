...
function CardHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "@container/card-header flex min-w-0 flex-col items-start gap-2 px-6 [.border-b]:pb-6",
        className
      )}
      {...props}
    />
...
function CardAction({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex w-full min-w-0 flex-col items-stretch gap-2 self-stretch",
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-w-0 flex-col items-stretch gap-2 px-6 [.border-t]:pt-6 sm:flex-row sm:flex-wrap sm:items-center",
        className
      )}
      {...props}
    />
